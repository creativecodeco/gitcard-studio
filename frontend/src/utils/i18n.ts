...
export const TRANSLATIONS = {
  ...
  en: {
    ...
    private_stats_desc:
      'Connect your GitHub account using our read-only App or register a PAT to include private repositories and organizations.',
    private_stats_guide: 'Read Help Guide →',
    connect_github_app: 'Connect with GitHub App',
    connect_github_desc:
      'Seamless and secure connection with automatic Refresh Tokens (metadata read-only).',
    ...
    private_stats_active_desc:
      'Your private repositories and organizations are now included in card generation.',
    ...
    delete_account_modal_desc:
      'This action will permanently delete your encrypted tokens, your history, and all server consumption metrics.',
