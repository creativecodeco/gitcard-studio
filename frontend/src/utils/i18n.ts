...
export const TRANSLATIONS = {
  es: {
    ...
    private_stats_desc: "Conecta tu cuenta de GitHub mediante nuestra App de solo lectura o registra un PAT para incluir repositorios privados y organizaciones.",
    private_stats_guide: "Leer Guía de Ayuda →",
    connect_github_app: "Conectar con GitHub App",
    connect_github_desc: "Conexión transparente y segura con Refresh Tokens automáticos (solo lectura de metadata).",
    ...
    private_stats_active_desc: "Tus repositorios privados y organizaciones ya se están incluyendo en la generación de tarjetas.",
    ...
    delete_account_modal_desc: "Esta acción eliminará de forma irreversible tus tokens cifrados, tu historial y todas tus métricas de consumo en el servidor.",
  ...
  en: {
    ...
    username_placeholder: "e.g. octocat",
    repo_label: "Specific Repository (Optional)",
    repo_placeholder: "e.g. gitcard-studio (or the most popular)",
    ...
    title_sponsors: "GitHub Sponsors",
    code_label_sponsors: "GitHub Sponsors",
    title_commit_activity: "Commit Activity Matrix",
    code_label_commit_activity: "Commit Activity Matrix",
    title_today_status: "Today's Commit Status",
    code_label_today_status: "Today's Status",
    title_timeline_matrix: "Coding Productivity Timeline",
    code_label_timeline_matrix: "Productivity Timeline",
    ...
    // Private stats elements
    private_stats_title: "Private Statistics & Account",
    private_stats_desc: "Connect your GitHub account using our read-only App or register a PAT to include private repositories and organizations.",
    private_stats_guide: "Read Help Guide →",
    connect_github_app: "Connect with GitHub App",
    connect_github_desc: "Seamless and secure connection with automatic Refresh Tokens (metadata read-only).",
    connect_pat_option: "Or enter a Personal Access Token (PAT) manually",
    ...
    private_stats_register_btn: "Register PAT Token",
    private_stats_active_label: "Active Connected Account",
    private_stats_active_desc: "Your private repositories and organizations are now included in card generation.",
    ...
    user_metrics_title: "Your Personal Metrics",
    user_views_label: "Profile Views:",
    card_renders_label: "Cards Rendered:",
    connected_as: "Connected as @{username}",
    disconnect_account_btn: "Disconnect Account",
    delete_account_btn: "Delete My Account & Data",
    delete_account_modal_title: "Confirm Account Deletion",
    delete_account_modal_desc: "This action will permanently delete your encrypted tokens, your history, and all server consumption metrics.",
